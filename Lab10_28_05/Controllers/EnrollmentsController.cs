...
namespace DAEA_LAB10_JE.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.CourseID = new SelectList(db.Courses.Where(x=>x.IsEnable==true), "CourseID", "Title");
            ViewBag.StudentID = new SelectList(db.Students.Where(x=>x.IsEnable==true), "StudentID", "LastName");
            return View();
        }
